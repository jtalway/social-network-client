...
class Comment extends Component {
  ...
  isValid = () => {
    ...
    if(!text.length > 0 || text.length > 150) {
      this.setState({error: "Comment should not be empty or more than 150 characters long."});
      return false;
    }
    return true;
  };
  ...
  // DELETE COMMENT - run by confirm delete below
      ...
      <div>
        ...
        <form onSubmit={ this.addComment }>
          <div className="form-group">
            ...
            />
            <button className="btn btn-sm btn-raised btn-success mt-2">
              Post
            </button>
          </div>
        </form>
